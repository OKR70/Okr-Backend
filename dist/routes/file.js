 ...
 */
router.post('/upload', authToken_1.authToken, uploadFile_1.uploadFile, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const document = Object.entries(Object.values(req.files)[0])[0][1];
        const filename = document.newFilename;
